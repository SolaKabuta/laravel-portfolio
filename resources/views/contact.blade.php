...
<body class="text-white bg-black">
        ...
        <div class="flex justify-center h-full p-96 ">
            ...
            <section class="flex justify-center bg-black p-7 rounded-2xl place-items-center">
                ...
                <form class="max-w-md mx-auto">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="tel" pattern="[0-9]{4} [0-9]{2} [0-9]{2} [0-9]{2}" name="floating_phone" id="floating_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            <label for="floating_phone" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone number (1234 56 78 91)</label>
                        </div>
                        <div class="relative z-0 w-full mb-5 group">
    ...
    <footer>
        <div class="container">
            <div class="absolute bottom-0 left-0 right-0 flex justify-center gap-5 pt-5 pb-5 text-center ">
